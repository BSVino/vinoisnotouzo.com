...
<?}?>
	...
	#ags_pullout_video {
		background-image: url("crucible.png");
	}
...
<body bgcolor="white" link="blue" vlink="blue" alink="red">
	...
	<? if (!$print) { ?>
		<div id="ags_pullout" class="pullout">
			<a target="_blank" href="http://youtu.be/riOjIThEZBw"><div id="ags_pullout_video" class="pullout_video">
				<video id="ags_video" width=100 height=100 autoplay loop>
	...
	<? } ?>
		...
		<div class="tasks">
			<div class="task">Engineering and technical design for <a target="_blank" href="https://youtu.be/riOjIThEZBw">Crucible</a>.</div>
		</div>
	</div>
	...
	<? } ?>
		<div class="dates">Feb 2014 - Dec 2015</div>
	...
	$( document ).tooltip();
		...
		<ul>
			<li><a href="#skills" class="skill" title="First professional work 2004. First game shipped in 2004. First programming language at 8 years old."><? echo date("Y")-2004; ?> years professional experience</a>
				...
				<a href="#skills" class="skill" title="Since 2005. Written in Python: The data collection and leaderboard code and some release/maintenance scripts for Double Action. Python scripts are used in docs.gl to generate static pages, which are then served directly from the web browser with no server side scripting, for maximum speed and offline usage.">Python</a>,
				<a href="#skills" class="skill" title="Since 1998. Written in PHP: The Double Action website (with Wordpress). The Digitanks website (with Wordpress). This resume. The SMAK website. The Strunkifier. My Gambler's Fallacy Dice Roller">PHP</a>,
				<a href="#skills" class="skill" title="Since 1997. At Providence Software to maintain their website, as part of their release process scripts, and for numerous side projects">Java</a>,
				<a href="#skills" class="skill" title="docs.gl. This resume. Gambler's Fallacy Dice Roller.">Javascript</a>)</li>
		...
		<ul>
			<li><a href="#skills" class="skill" title="Math for Game Developers. UCLA Mathematics of Computation - in progress">Mathematics</a>:</li>
				<div style="padding-left: 45px;">
				<a href="#skills" class="skill" title="Every game ever uses linear algebra and mine are no exception. We can save time in the interview if you skip past the easy dot product/cross product questions.">linear algebra</a>,
