...
<body bgcolor="white" link="blue" vlink="blue" alink="red">
	...
	<div id="allinfo">
		<div style="text-align: center; margin: 10px;"><em>Video Game Systems Designer</em></div>
	...
	<div id="da_experience" class="experience">
		...
		<div class="tasks">
			<div class="task">Designed and implemented game systems: multiplayer slowmo, mini-objectives, stunt system.</div>
	...
	<div class="experience">
		...
		<div class="tasks">
			...
			<div class="task">Designed the game's systems: unit types, tech tree, combat systems.</div>
	...
	<div id="cf_experience" class="experience">
		...
		<div class="tasks">
			<div class="task">Designed and implemented game systems like sword-fighting, magic system, game modes, and novel movement systems.</div>
