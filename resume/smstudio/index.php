...
<body bgcolor="white" link="blue" vlink="blue" alink="red">
	...
	<div id="ags_experience" class="experience">
		<div class="dates">Mar 2019 - Present</div>
		<b>Amazon Game Studios</b>
		<i>Systems and Combat Designer.</i><br/>
		<div style="font-size: smaller;">Titles: <em>Crucible, Unannounced</em></div>
		<div class="tasks">
			<div class="task">Product owner of combat/abilities-related feature (unannounced). Own implementation, backlog, roadmap, prioritization of new features.</div>
	...
	<div id="ags_experience" class="experience">
		...
		<i>Engineer.</i><br/>
		<div class="tasks">
			<div class="task">Engineering and technical design for <a target="_blank" href="https://youtu.be/riOjIThEZBw">Crucible</a> in C++.</div>
	...
	<div id="da_experience" class="experience">
		...
		<i>Combat Designer, Software Engineer.</i><br/>
		<div style="font-size: smaller;">Titles: <em>Double Action: Boogaloo</em></div>
		<div class="tasks">
			<div class="task"><a target="_blank" href="http://store.steampowered.com/app/317360/">Shipped on Steam</a> in mid 2014, 92% positive reviews.</div>
			<div class="task">Designed and implemented combat mechanics: multiplayer slowmo, mini-objectives, stunt system.</div>
	...
	<div class="experience">
		...
		<b>Lunar Workshop</b> <i>Lead Designer, Software Engineer.</i><br/>
		...
		<div class="tasks">
			...
			<div class="task">Designed the game's combat systems, unit types, tech tree.</div>
		</div>
	</div>
	...
	<div id="cf_experience" class="experience">
		...
		<div class="tasks">
			<div class="task">Designed and implemented game mechanics like sword-fighting, magic system, and movement systems.</div>
