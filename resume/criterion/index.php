...
<body bgcolor="white" link="blue" vlink="blue" alink="red">
	...
	<div id="da_experience" class="experience">
		...
		<div class="tasks">
			<div class="task">Designed and implemented game mechanics: multiplayer slowmo, mini-objectives, firearm combat.</div>
			<div class="task">Designed an animation-based stunt system for use during multiplayer combat.</div>
	...
	<div class="experience">
		...
		<div class="tasks">
			...
			<div class="task">Built the Tinker game engine in C++: physics, animation, renderer.</div>
		</div>
	</div>
	...
	<div id="cf_experience" class="experience">
		...
		<div class="tasks">
			<div class="task"><a target="_blank" href="http://youtu.be/HHHmOTO993Y">Designed</a> game mechanics like sword-fighting, magic system, game modes, and novel movement systems.</div>
			<div class="task">Implemented designs in Valve's Source engine in C++.</div>
			<div class="task">Designed an animation-based sword-fighting system for multiplayer melee combat.</div>
		</div>
	</div>
