...
<body bgcolor="white" link="blue" vlink="blue" alink="red">
	...
	<? } ?>
		...
		<div class="tasks">
			<div class="task">Engineering for <a target="_blank" href="https://youtu.be/riOjIThEZBw">Crucible</a> in C++ and Lua.</div>
	...
	<? } ?>
		...
		<b>Double Action Factory</b>
		<i>Designer, Programmer.</i><br/>
		<div style="font-size: smaller;">Games shipped: <em>Double Action: Boogaloo</em></div>
		<div class="tasks">
			...
			<div class="task">Worked with artists audio and animators to integrate and iterate on content.</div>
			<div class="task">Maintained the feature set and schedule over the 3 year lifespan of the project.</div>
	...
	<? } ?>
		...
		<div style="font-size: smaller;">Games shipped: <em>Digitanks</em></div>
		<div class="tasks">
	...
	<? } ?>
		...
		<i>Designer, Programmer.</i><br>
		<div class="tasks">
			<div class="task"><a target="_blank" href="http://youtu.be/HHHmOTO993Y">Designed and implemented</a> game mechanics for an unreleased first/third person multiplayer RPG.</div>
			<div class="task">Designed and implemented the game's user interface and heads-up display.</div>
			<div class="task">Contributed to environment art, level design, character designs, story, and audio.</div>
		</div>
	</div>
	...
	<div class="experience">
		<div class="tasks">
			<div class="task"><i>Talk - <a target="_blank" href="https://www.youtube.com/watch?v=RpZKsHliHXk">"Defense against a rogue artificial intelligence"</a></i>, BahFest, 2015. A short comedy-science talk.</div>
			<div class="task"><i>Talk - <a target="_blank" href="https://youtu.be/Nztt9kFvObU">"Double Action: Postmortem"</a></i>, East Coast Game Conference, 2015. On differentiating a design in a crowded market by iteration towards guiding principles.</div>
