...
<body bgcolor="white" link="blue" vlink="blue" alink="red">
	...
	<div id="ags_experience" class="experience">
		<div class="dates">Nov 2017 - Present</div>
		...
		<div class="tasks">
			...
			<div class="task">Training and mentoring SDET/QA teammates to take over maintenance and future feature work.</div>
		</div>
	</div>
	...
	<div class="experience">
		...
		<div class="tasks">
			<div class="task">Designed and implemented gameplay systems for Digitanks in C++</div>
			...
			<div class="task">Created <a target="_blank" href="https://www.youtube.com/watch?v=vzF4IUAhqgI">Viewback</a>, a mobile wireless telemetry game data tool for designers.</div>
		</div>
	</div>
	...
	<div id="cf_experience" class="experience">
		...
		<b>Matreya Studios</b>
		<i>Designer, Software Engineer.</i><br>
		<div style="font-size: smaller;">Titles: <em>Calamity Fuse [cancelled]</em></div>
		<div class="tasks">
			<div class="task"><a target="_blank" href="http://youtu.be/HHHmOTO993Y">Designed and implemented</a> game mechanics like sword-fighting, magic system, game modes.</div>
