...
<li><? if (lang_es()) echo "Matematico"; else echo "A mathematician" ?></li>
<li><? if (lang_es()) echo "Due&ntilde;o de perro"; else echo "A dog owner" ?></li>
<li><? if (lang_es()) echo "Estudiante de Espa&ntilde;ol"; else echo "A Spanish speaker" ?></li>
<li><? if (lang_es()) echo "M&uacute;sico"; else echo "A musician" ?></li>
<li><? if (lang_es()) echo "Malabarista"; else echo "A juggler" ?></li>
...
<p>
  ...
  Twitter: <a href="http://twitter.com/cubesos">@cubesos</a><br />
...
<h3><? if (lang_es()) echo "Proyectos"; else echo "Projects" ?></h3>
<UL>
...
<li><a href="http://github.com/BSVino/vtb/">Vino's Tool Box</a> - <? if (lang_es()) echo "Caja de Herramientas de Vino - Una biblioteca de herramientas &uacute;tiles de C, similar a la biblioteca <a href='http://github.com/nothings/stb'>stb</a>."; else echo "A library of useful C utilities, in the style of the <a href='http://github.com/nothings/stb'>stb libraries</a>." ?></li>
<li><a href="https://github.com/BSVino/JaiPrimer/blob/master/JaiPrimer.md">Jai Primer</a> - <? if (lang_es()) echo "Descripci&oacute;n de la lengua de programaci&oacute;n Jai, desarrollado por <a href='http://twitter.com/Jonathan_Blow'>Jonathan Blow</a>."; else echo "A description of the programming language Jai, currently under development by <a href='http://twitter.com/Jonathan_Blow'>Jonathan Blow</a>." ?></li>
...
<li><a href="https://www.youtube.com/watch?v=7JXZ85KLVVw">Blue Ocean</a> - <? if (lang_es()) echo "Un proyecto para probar nuevos t&eacute;cnicos matem&aacute;ticos."; else echo "A test project to try out new mathematical techniques." ?></li>
...
<h3><? if (lang_es()) echo "Presentaci&oacute;nes"; else echo "Talks" ?></h3>
<ul>
<li><a href="https://youtu.be/eo2HNCTV78s"><em>Understanding Quaternions through Geometric Algebra</em></a>, Online 2017</li>
<li><a href="https://youtu.be/MUNRvqpske0"><em>Debugging Optimized x64 Code</em></a>, Online 2016</li>
<li><a href="https://youtu.be/vGGg25f1_l0"><em>Enumerative Combinatorics</em></a>, Online 2016</li>
<li><a href="https://www.youtube.com/watch?v=ceDh1fkKwgY"><em>Visual Vectors - An Intuitive 3D Math Crash Course</em></a>, Nodevember 2015</li>
<li><a href="https://www.youtube.com/watch?v=RpZKsHliHXk"><em>A Proposed Defense Against the Threat of a Rogue Artificial Intelligence</em></a>, BahFest Seattle 2015. A comedy talk about science and technology.</li>
<li><a href="https://www.youtube.com/watch?v=Nztt9kFvObU"><em>Double Action: Postmortem - Or, How I Made A Successful Game for Zero Dollars</em></a>, ECGC 2015</li>
</ul>
...
<li><A HREF="http://www.youtube.com/watch?v=rAcL9engudQ">Forever Gone</A></li>
